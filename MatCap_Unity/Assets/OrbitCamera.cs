...
public class OrbitCamera : MonoBehaviour
{
	...
	[HideInInspector]
	public float Y_MinLimit = -85;
	[HideInInspector]
	//15.0f;
	public float Y_MaxLimit = 85;
	//70.0f;
	...
	void OnDrawGizmos ()
	{
		Vector3 center = TargetLookAt.gameObject.GetComponentsInChildren<MeshRenderer> () [0].bounds.center;
		float radius = TargetLookAt.gameObject.GetComponentsInChildren<MeshRenderer> () [0].bounds.extents.magnitude;
	...
	void Start ()
	{
		Centre = TargetLookAt.gameObject.GetComponentsInChildren<MeshRenderer> () [0].bounds.center;
		Radius = TargetLookAt.gameObject.GetComponentsInChildren<MeshRenderer> () [0].bounds.extents.magnitude;
	...
	Vector3 CalculatePosition (float rotationX, float rotationY, float distance)
	{
		...
		return Centre + (rotation * direction);
	}
